...
#      AIWORKHUB_ALLOW_WRITES exactly as before).
...
TMPDIR_AUDIT="$(mktemp -d "${TMPDIR:-/tmp}/aiworkhub_b119_allowlist_sh.XXXXXX")"
...
from aiworkhub import core, launch_queue_contract as lqc
