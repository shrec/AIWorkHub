...
def test_eval_artifact_matches_rendered_policy() -> None:
    path = Path("tools/geoai-task-mcp/eval/aiworkinghub_agent_tool_instruction_generator_b816_v2.json")
    payload = json.loads(path.read_text(encoding="utf-8"))
    assert payload["schema_id"] == "geoai.task_mcp.agent_tool_instruction_generator_b816_v2.eval.v1"
