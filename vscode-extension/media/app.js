...
const elements = {
  ...
  headerSkills: document.querySelector("#header-skills"),
  headerToolRecipes: document.querySelector("#header-tool-recipes"),
  headerSemanticEdit: document.querySelector("#header-semantic-edit-coverage"),
  codingFoundationDialog: document.querySelector("#coding-foundation-dialog"),
  codingFoundationDialogTitle: document.querySelector("#coding-foundation-dialog-title"),
  codingFoundationDialogSummary: document.querySelector("#coding-foundation-dialog-summary"),
  codingFoundationDialogBody: document.querySelector("#coding-foundation-dialog-body"),
