"""Multi-repository window/session mux for AIWorkingHub.
...
from .route_identity import RepoRouteKey
...
class WindowRepositorySession:
    ...
    child_id: str
    stopped: bool = False
    pending: list[RepoRouteKey] = field(default_factory=list)
    ...
    def drain(self) -> tuple[RepoRouteKey, ...]:
...
class RepositoryWindowMux:
    ...
    def deliver_callback(self, route: RepoRouteKey) -> DurableCallback | None:
