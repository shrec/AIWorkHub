"""B821 MCP tool surface for AIWorkingHub agent tool-instruction activation.
...
MCP_TOOL_NAMES: tuple[str, ...] = (
    "geoai_agent_tool_instruction_preview",
    "geoai_agent_tool_instruction_inspect",
    "geoai_agent_tool_instruction_apply",
)
...
MCP_TOOLS: dict[str, Any] = {
    "geoai_agent_tool_instruction_preview": _mcp_preview,
    "geoai_agent_tool_instruction_inspect": _mcp_inspect,
    "geoai_agent_tool_instruction_apply": _mcp_apply,
}
