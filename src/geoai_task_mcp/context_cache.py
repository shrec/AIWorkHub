...
KEY_SCHEMA_ID = "geoai.task_mcp.context_cache_key.v1"
ENTRY_SCHEMA_ID = "geoai.task_mcp.context_cache_entry.v1"
REUSE_SCHEMA_ID = "geoai.task_mcp.context_cache_reuse.v1"
QUERY_REUSE_SCHEMA_ID = "geoai.task_mcp.context_query_reuse_key.v1"
