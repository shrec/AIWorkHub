...
_EDITOR_BRIDGE_DISPATCH = "src/aiworkhub/process_launcher.py:11555-11634"
    ...
    capabilities=MappingProxyType(
        {
            ...
            # (process_launcher.py:11624-11631), so the common claim that "the
            ...
            CAPABILITY_WORKER_SEMANTIC_EDIT: _record(
                ...
                CAPABILITY_SUPPORTED,
                EVIDENCE_DECLARED_FROM_CODE_PATH,
                evidence="src/aiworkhub/process_launcher.py:11557-11567",
            ),
            CAPABILITY_SOURCE_GRAPH_QUERY: _record(
                CAPABILITY_SOURCE_GRAPH_QUERY,
                CAPABILITY_SUPPORTED,
                EVIDENCE_DECLARED_FROM_CODE_PATH,
                evidence="src/aiworkhub/process_launcher.py:11555-11556",
            ),
        }
    ),
)
