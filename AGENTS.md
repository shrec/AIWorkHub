...
Kilo manager startup (copied from CLAUDE.md; mandatory when AIWorkHub MCP is available):
...
- Direct Kilo chats use manager tools; launched task workers use worker tools.
